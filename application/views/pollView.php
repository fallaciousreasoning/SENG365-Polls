        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a class="navbar-brand" href="#/admin"><span class="glyphicon glyphicon-pencil nav-header">Admin</span></a></li>
                    <li><a class="navbar-brand" href="#/about"><span class="glyphicon glyphicon-info-sign nav-header">About</span></a></li>
                </ul>
            </div>
        </nav>
